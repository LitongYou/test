extraction_prompts = {
    ...
    Q: I'm recovering from illness and missed Strata’s lecture. My classmate sent me an audio file where the professor discussed topics for the Calculus midterm. I need to know the reading pages. The file is named Homework.mp3. Please list the page numbers in increasing order, comma-separated.
