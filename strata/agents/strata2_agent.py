...
class StrataAgent(BaseAgent):
    ...
    StrataAgent supports dynamic decomposition of high‑level tasks into subtasks, retrieval
    ...
    def __init__(self, planner_cls, retriever_cls, executor_cls, ToolManager, config):
        """
        Initialize a new StrataAgent with the specified modules and configuration.
