...
class StrataAgent(BaseAgent):
    """
    StrataAgent coordinates task execution by integrating planning, retrieval, and execution modules.
    ...
    def __init__(self, planner_cls, retriever_cls, executor_cls, ToolManager, config):
        """
        Initialize StrataAgent with the given planner, retriever, and executor classes, plus configuration.
        ...
        try:
            fetch_os_info(self.system_version)
