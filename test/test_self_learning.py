...
class TestSelfLearning:
    ...
    def setup_method(self, method):
        ...
        self.strata_agent = StrataAgent(StrataPlanner, StrataRetriever, StrataExecutor, ToolManager, config=self.args)
        self.self_learning = SelfLearning(self.strata_agent, SelfLearner, ToolManager, self.args, TextExtractor)
    ...
    def test_learn_course(self):
        ...
        course = {
                    "read_contents_of_Sheet1": "Task: Use openpyxl to read all the contents of sheet 'Sheet1' in Invoices.xlsx. Input: The path of file and the sheet name. Output: All the content of sheet 'Sheet1' in Invoices.xlsx. File Path: /home/heroding/桌面/STRATA_self_learning/jarvis/working_dir/Invoices.xlsx",
                    "read_contents_of_Sheet2": "Task: Use openpyxl to read all the contents of sheet 'Sheet2' in Invoices.xlsx. Input: The path of file and the sheet name. Output: All the content of sheet 'Sheet2' in Invoices.xlsx. File Path: /home/heroding/桌面/STRATA_self_learning/jarvis/working_dir/Invoices.xlsx",
                    "insert_new_sheet": "Task: Use openpyxl to insert a new sheet named 'Summary' into Invoices.xlsx. Input: The path of file and the name of the new sheet. Output: None. File Path: /home/heroding/桌面/STRATA_self_learning/jarvis/working_dir/Invoices.xlsx",
                    "calculate_total_sales": "Task: Use openpyxl to calculate the total sales from the 'Sales' column in sheet 'Sheet1'. Input: The path of the file, sheet name, and column name. Output: The total sales amount. File Path: /home/heroding/桌面/STRATA_self_learning/jarvis/working_dir/Invoices.xlsx",
                    "update_price_with_discount": "Task: Use openpyxl to apply a 10% discount to all 'Price' values in sheet 'Sheet1' and update the sheet accordingly. Input: The path of the file, sheet name, and discount percentage. Output: None, but the 'Price' column in 'Sheet1' should be updated with discounted prices. File Path: /home/heroding/桌面/STRATA_self_learning/jarvis/working_dir/Invoices.xlsx",
                    "calculate_acceleration_formula": "Task: Use openpyxl to calculate the acceleration for each 'Hanging Mass (m2) (kg)' in sheet 'Sheet2' using the formula provided in the sheet and update the 'Acceleration (m/s^2)' column. Input: The path of the file and sheet name. Output: None, but the 'Acceleration (m/s^2)' column in 'Sheet2' should be updated with calculated values. File Path: /home/heroding/桌面/STRATA_self_learning/jarvis/working_dir/Invoices.xlsx",
                    "generate_sales_report": "Task: Use openpyxl to create a new sheet named 'Sales Report' that summarizes the total sales per 'Sales Rep' from sheet 'Sheet1'. Input: The path of the file and the name of the new sheet. Output: None, but a new sheet 'Sales Report' should be created with each 'Sales Rep' and their corresponding total sales. File Path: /home/heroding/桌面/STRATA_self_learning/jarvis/working_dir/Invoices.xlsx",
                    "plot_sales_histogram": "Task: Use openpyxl to plot a histogram for the sales data in sheet 'Sheet1' of Invoices.xlsx. Input: The path of the file and sheet name. Output: None, but a histogram plot should be generated and saved within the workbook. File Path: /home/heroding/桌面/STRATA_self_learning/jarvis/working_dir/Invoices.xlsx"
                }   
