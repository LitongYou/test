...
from strata import StrataPlanner, ToolManager
from strata.prompts.strata_pt import prompt

class TestPlanner:
    """
    A test class for verifying the functionality of the StrataPlanner class.
    ...
    def setup_method(self, method):
        ...
        This method prepares the StrataPlanner instance by configuring it with necessary settings and a predefined
        ...
        self.planner = StrataPlanner(self.prompt)

    def test_decompose_task(self):
        """
        Test to verify that the task decomposition process in the StrataPlanner does not result in an empty subtask list.
